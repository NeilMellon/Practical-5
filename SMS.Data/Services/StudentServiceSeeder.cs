...
namespace SMS.Data.Services
{
    public static class StudentServiceSeeder
    {
        ...
        public static void Seed(IStudentService svc)
        {
            ...
            // add students
            svc.AddStudent("Homer Simpson","Physics", "homer@mail.com", 41, 56, "https://2.bp.blogspot.com/-PrlSWASvdoI/TWUy3pNAlyI/AAAAAAAAmGQ/NNHPgyCj4s4/s1600/Homer_Simpson_Wallpapers.jpg" );
